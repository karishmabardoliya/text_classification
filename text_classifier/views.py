...
def model_train():
    ...
    train_data = pd.read_csv("/Users/c100-60/Desktop/Classification/data/train.csv", names=COLUMN_NAME)
    X_train, y_train = train_data, train_data.pop('Category')
    test_data = pd.read_csv("/Users/c100-60/Desktop/Classification/data/test.csv", names=COLUMN_NAME)
...
def index(request):
    ...
    CATEGORY = ['Animals','Beauty & Style','Business & Finance','Technology','Education','Entertainment','Environment','Food & Drink','Health & Medicines']
    context_dict={}
